...
public:
  ...
  void Init() {
    ...
    AddDataset_NGTCXS("ttbar_bbbar_semileptonic","ttbar"         , 1, 2 ,   19200,   {  2991789,   3223118,   7318891,  10378681}); //  5
    AddDataset_NGTCXS("ttbar_bbbar_leptonic"    ,"ttbar"         , 1, 2 ,    4600,   {  1388348,   1571799,   3472503,   4792850}); //  6
    AddDataset_NGTCXS("ttbar_bbbar_hadronic"    ,"ttbar"         , 1, 2 ,   19900,   {  2303410,   2597868,   5694656,   8049064}); //  7


    AddDataset_NGTCXS("wjets_HT_70_100"         ,"wjets"         , 1, 3 , 1292000,   { 16931765,  19439931,  44576510,  66220256}); //  8
    AddDataset_NGTCXS("wjets_HT_100_200"        ,"wjets"         , 1, 3 , 1395000,   { 21734530,  19753958,  47424468,  51408967}); //  9
    AddDataset_NGTCXS("wjets_HT_200_400"        ,"wjets"         , 1, 3 ,  407900,   { 17870845,  15067621,  42281979,  58225632}); // 10
    AddDataset_NGTCXS("wjets_HT_400_600"        ,"wjets"         , 1, 3 ,   57480,   {  2467498,   2115509,   5468473,   7444030}); // 11
    AddDataset_NGTCXS("wjets_HT_600_800"        ,"wjets"         , 1, 3 ,   12870,   {  2344130,   2251807,   5545298,   7718765}); // 12
    AddDataset_NGTCXS("wjets_HT_800_1200"       ,"wjets"         , 1, 3 ,    5366,   {  2510487,   2132228,   5088483,   7306187}); // 13
    AddDataset_NGTCXS("wjets_HT_1200_2500"      ,"wjets"         , 1, 3 ,    1074,   {  2119975,   2090561,   4752118,   6481518}); // 14
    AddDataset_NGTCXS("wjets_HT_2500_inf"       ,"wjets"         , 1, 3 ,       8,   {   808649,    709514,   1185699,   2097648}); // 15
    // AddDataset_NGTCXS("wjets_inclusive"        ,"wjets"         , 1, 3 , 0,       {0,0,0,0});                     

    AddDataset_NGTCXS("single_top_schan"        ,"single_top"    , 1, 4 ,    3740,   {  5518000,   5471000,  13620000,  19365999}); // 16
    AddDataset_NGTCXS("single_top_tchan"        ,"single_top"    , 1, 4 ,  115300,   { 55961000,  63073000, 129903000, 178336000}); // 17
    AddDataset_NGTCXS("single_antitop_tchan"    ,"single_top"    , 1, 4 ,   69090,   { 31024000,  30609000,  69793000,  95627000}); // 18
    AddDataset_NGTCXS("single_top_tw"           ,"single_top"    , 1, 4 ,   34910,   {  3614470,   3470455,   8322161,  12379320}); // 19
    AddDataset_NGTCXS("single_antitop_tw"       ,"single_top"    , 1, 4 ,   34970,   {  3594458,   4002310,   8166788,  11779400}); // 20

    AddDataset_NGTCXS("WW"                      ,"diboson"       , 1, 5 ,   51650,   { 20071678,  19976139,  39931603,  40272013}); // 21
    AddDataset_NGTCXS("ZZ"                      ,"diboson"       , 1, 5 ,   12170,   {  1282000,   1151000,   2706000,   3526000}); // 22
    ...
    //AddDataset_NGTCXS("qcd_HT_50_100"        	,"qcd"         	 , 1, 6 ,187300000000,{12233035,  11197186,  26243010,	38521609}); // 27 
    //AddDataset_NGTCXS("qcd_HT_100_200"       	,"qcd"         	 , 1, 6 ,23590000000,{ 26312661,  23717410,  54381393,	79857456}); // 28 
    AddDataset_NGTCXS("qcd_HT_200_300"       	,"qcd"         	 , 1, 6 ,1555000000, { 16524587,  17569141,  42714435,	61542214}); // 29 27
    AddDataset_NGTCXS("qcd_HT_300_500"      	,"qcd"         	 , 1, 6 ,324500000,  { 15341307,  16747056,  43429979,	56214199}); // 30 28
    AddDataset_NGTCXS("qcd_HT_500_700"       	,"qcd"         	 , 1, 6 ,30310000,   { 15775001,  14212819,  36194860,	61097673}); // 31 29
    AddDataset_NGTCXS("qcd_HT_700_1000"      	,"qcd"         	 , 1, 6 , 6444000,   { 15808790,  13750537,  32934816,	47314826}); // 32 30
    AddDataset_NGTCXS("qcd_HT_1000_1500"     	,"qcd"         	 , 1, 6 , 1127000,   {  4773503,   4365993,  10186734,	15230975}); // 33 31
    AddDataset_NGTCXS("qcd_HT_1500_2000"      	,"qcd"         	 , 1, 6 ,  109800,   {  3503675,   3003707,   7701876,	11887406}); // 34 32
    AddDataset_NGTCXS("qcd_HT_2000_Inf"      	,"qcd"         	 , 1, 6 ,   21980,   {  1629000,   1847781,   4112573,	 5710430}); // 35 33
    ...
    // now 36 to 53
    AddDataset_NGTCXS("FL300"                   ,"M300"          , 2, 4 , 683.8,   {542974, 451706,  989541,  973312}); // 27 34
    AddDataset_NGTCXS("FL400"                   ,"M400"          , 2, 5 , 321.7,   {542917, 457628, 1009763, 1005777}); // 28 35
    AddDataset_NGTCXS("FL500"                   ,"M500"          , 2, 6 , 161.1,   {539889, 472634,  990910,  995846}); // 29 36
    AddDataset_NGTCXS("FL600"                   ,"M600"          , 2, 7 , 85.92,   {538626, 459533, 1002905, 1013268}); // 30 37
    AddDataset_NGTCXS("FL700"                   ,"M700"          , 2, 8 , 48.84,   {536088, 458032,  993657, 1007434}); // 31 38
    AddDataset_NGTCXS("FL800"                   ,"M800"          , 2, 9 , 29.81,   {544804, 457557,  989717,  994770}); // 32 39
    AddDataset_NGTCXS("FL900"                   ,"M900"          , 2, 30, 18.33,   {537197, 459185,  996690, 1014207}); // 33 40
    AddDataset_NGTCXS("FL1000"                  ,"M1000"         , 2, 40, 11.73,   {533034, 443584,  999049,  999380}); // 34 41
    AddDataset_NGTCXS("FL1100"                  ,"M1100"         , 2, 46, 7.683,   {467268, 466768, 1001850,  986599}); // 35 42

    AddDataset_NGTCXS("LL300"                   ,"M300"          , 2, 4 , 708.3,   {533339, 463438, 1016545,  979122}); // 36 43
    AddDataset_NGTCXS("LL400"                   ,"M400"          , 2, 5 , 336.1,   {527708, 451102,  991505,  990858}); // 37 44
    AddDataset_NGTCXS("LL500"                   ,"M500"          , 2, 6 , 165.3,   {548554, 462578,  990701, 1001088}); // 38 45
    AddDataset_NGTCXS("LL600"                   ,"M600"          , 2, 7 , 85.82,   {530042, 467804,  997101,  995847}); // 39 46  
    AddDataset_NGTCXS("LL700"                   ,"M700"          , 2, 8 , 47.47,   {539337, 454955,  999882,  993510}); // 40 47
    AddDataset_NGTCXS("LL800"                   ,"M800"          , 2, 9 , 27.73,   {541417, 462499,  978958,  988361}); // 41 48
    AddDataset_NGTCXS("LL900"                   ,"M900"          , 2, 30, 16.49,   {534297, 464288, 1015927, 1006881}); // 42 49
    AddDataset_NGTCXS("LL1000"                  ,"M1000"         , 2, 40, 10.25,   {540970, 457909,  998840, 1008866}); // 43 50
    AddDataset_NGTCXS("LL1100"                  ,"M1100"         , 2, 46, 6.546,   {535810, 461040,  990631, 1010305}); // 44 51
