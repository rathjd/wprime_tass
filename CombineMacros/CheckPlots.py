...
if JetMult == 5:
  ...
  SFfitUp.SetParameters(cov(0,0), #0: x^-6
                        ...
                        cov(1,1), #2: x^-4
                        -cov(0,3)-cov(3,0), #3: x^-3
                        -cov(1,3)-cov(3,1)-cov(4,0)-cov(0,4)+SFfit.GetParameter(0), #4: x^-2
                        -cov(1,4)-cov(4,1)+SFfit.GetParameter(1), #5: x^-1
  ...
  SFfitUp.SetParameters(cov(0,0), #0: x^-6
                        ...
                        cov(1,1), #2: x^-4
                        -cov(0,3)-cov(3,0), #3: x^-3
                        -cov(1,3)-cov(3,1)+SFfit.GetParameter(0), #4: x^-2
